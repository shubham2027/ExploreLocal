            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between p-6 bg-white shadow-lg rounded-xl border border-gray-100 sticky bottom-4">
                        ...
                        <Link to={`/booking/${experience.id}`} className="bg-indigo-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-indigo-700 transition shadow-md hover:shadow-lg transform hover:-translate-y-0.5 inline-block text-center">
                            Book Now
                        </Link>
                    </div>
                </div>
